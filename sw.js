// Cache-first service worker. A single cache tier, versioned so a
...
// hit the network and stash a copy for next time. Simple, predictable, and
// correct for static, versioned assets that never change without a
// CACHE_VERSION bump.
